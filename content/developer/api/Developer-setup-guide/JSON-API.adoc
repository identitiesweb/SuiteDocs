...
=== Update the cleint secret
Go back to the oauth client credentials in suitecrm admin as set up in  [configure authentication]https://docs.suitecrm.com/developer/api/developer-setup-guide/configure-authentication/
click "edit" and change the secret to your new OAUTH2_ENCRYPTION_KEY
